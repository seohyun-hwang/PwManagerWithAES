...
public class PwManager {
    ...
    public boolean encryptAndSave() {
        try {
            ...
            out.writeObject(encryptObject(masterPw, masterPw)); //writes encrypted master-pw
            out.writeObject(encryptObject((ArrayList<PwInfo>) pwInfoList, masterPw)); //writes encrypted pwInfoList array
